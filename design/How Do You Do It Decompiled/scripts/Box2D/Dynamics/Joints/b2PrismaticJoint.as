package Box2D.Dynamics.Joints
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         m_K.col1.y = _loc10_ * m_s1 + _loc12_ * m_s2;
         m_K.col1.z = _loc10_ * m_s1 * m_a1 + _loc12_ * m_s2 * m_a2;
         m_K.col2.x = m_K.col1.y;
         m_K.col2.y = _loc10_ + _loc12_;
         m_K.col2.z = _loc10_ * m_a1 + _loc12_ * m_a2;
         m_K.col3.x = m_K.col1.z;
         m_K.col3.y = m_K.col2.z;
         m_K.col3.z = _loc5_ + _loc7_ + _loc10_ * m_a1 * m_a1 + _loc12_ * m_a2 * m_a2;
         if(m_enableLimit)
         {
         ...
         if(param1.warmStarting)
         {
            ...
            _loc11_ = m_impulse.x * m_perp.x + (m_motorImpulse + m_impulse.z) * m_axis.x;
            _loc13_ = m_impulse.x * m_perp.y + (m_motorImpulse + m_impulse.z) * m_axis.y;
            _loc8_ = m_impulse.x * m_s1 + m_impulse.y + (m_motorImpulse + m_impulse.z) * m_a1;
            _loc9_ = m_impulse.x * m_s2 + m_impulse.y + (m_motorImpulse + m_impulse.z) * m_a2;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc2_:b2Body = m_bodyB;
         var _loc21_:b2Vec2 = _loc24_.m_linearVelocity;
         var _loc18_:Number = _loc24_.m_angularVelocity;
         var _loc23_:b2Vec2 = _loc2_.m_linearVelocity;
         var _loc22_:Number = _loc2_.m_angularVelocity;
         if(m_enableMotor && m_limitState != 3)
         {
            _loc16_ = m_axis.x * (_loc23_.x - _loc21_.x) + m_axis.y * (_loc23_.y - _loc21_.y) + m_a2 * _loc22_ - m_a1 * _loc18_;
            _loc19_ = m_motorMass * (m_motorSpeed - _loc16_);
            _loc20_ = m_motorImpulse;
            _loc17_ = param1.dt * m_maxMotorForce;
            m_motorImpulse = b2Math.Clamp(m_motorImpulse + _loc19_,-_loc17_,_loc17_);
            _loc19_ = m_motorImpulse - _loc20_;
            _loc9_ = _loc19_ * m_axis.x;
            _loc10_ = _loc19_ * m_axis.y;
            _loc5_ = _loc19_ * m_a1;
            _loc6_ = _loc19_ * m_a2;
            _loc21_.x = _loc21_.x - m_invMassA * _loc9_;
            _loc21_.y = _loc21_.y - m_invMassA * _loc10_;
            _loc18_ = _loc18_ - m_invIA * _loc5_;
            _loc23_.x = _loc23_.x + m_invMassB * _loc9_;
            _loc23_.y = _loc23_.y + m_invMassB * _loc10_;
            _loc22_ = _loc22_ + m_invIB * _loc6_;
         }
         var _loc7_:Number = m_perp.x * (_loc23_.x - _loc21_.x) + m_perp.y * (_loc23_.y - _loc21_.y) + m_s2 * _loc22_ - m_s1 * _loc18_;
         var _loc4_:Number = _loc22_ - _loc18_;
         if(m_enableLimit && m_limitState != 0)
         {
            _loc13_ = m_axis.x * (_loc23_.x - _loc21_.x) + m_axis.y * (_loc23_.y - _loc21_.y) + m_a2 * _loc22_ - m_a1 * _loc18_;
            _loc11_ = m_impulse.Copy();
            _loc3_ = m_K.Solve33(new b2Vec3(),-_loc7_,-_loc4_,-_loc13_);
            ...
            _loc14_ = -_loc7_ - (m_impulse.z - _loc11_.z) * m_K.col3.x;
            _loc15_ = -_loc4_ - (m_impulse.z - _loc11_.z) * m_K.col3.y;
            _loc8_ = m_K.Solve22(new b2Vec2(),_loc14_,_loc15_);
            _loc8_.x = _loc8_.x + _loc11_.x;
            _loc8_.y = _loc8_.y + _loc11_.y;
            m_impulse.x = _loc8_.x;
            m_impulse.y = _loc8_.y;
            _loc3_.x = m_impulse.x - _loc11_.x;
            _loc3_.y = m_impulse.y - _loc11_.y;
            _loc3_.z = m_impulse.z - _loc11_.z;
            _loc9_ = _loc3_.x * m_perp.x + _loc3_.z * m_axis.x;
            _loc10_ = _loc3_.x * m_perp.y + _loc3_.z * m_axis.y;
            _loc5_ = _loc3_.x * m_s1 + _loc3_.y + _loc3_.z * m_a1;
            _loc6_ = _loc3_.x * m_s2 + _loc3_.y + _loc3_.z * m_a2;
            _loc21_.x = _loc21_.x - m_invMassA * _loc9_;
            _loc21_.y = _loc21_.y - m_invMassA * _loc10_;
            _loc18_ = _loc18_ - m_invIA * _loc5_;
            _loc23_.x = _loc23_.x + m_invMassB * _loc9_;
         ...
         {
            _loc12_ = m_K.Solve22(new b2Vec2(),-_loc7_,-_loc4_);
            m_impulse.x = m_impulse.x + _loc12_.x;
            m_impulse.y = m_impulse.y + _loc12_.y;
            _loc9_ = _loc12_.x * m_perp.x;
            _loc10_ = _loc12_.x * m_perp.y;
            _loc5_ = _loc12_.x * m_s1 + _loc12_.y;
            _loc6_ = _loc12_.x * m_s2 + _loc12_.y;
            _loc21_.x = _loc21_.x - m_invMassA * _loc9_;
            _loc21_.y = _loc21_.y - m_invMassA * _loc10_;
            _loc18_ = _loc18_ - m_invIA * _loc5_;
            _loc23_.x = _loc23_.x + m_invMassB * _loc9_;
         ...
         _loc24_.m_linearVelocity.SetV(_loc21_);
         _loc24_.m_angularVelocity = _loc18_;
         _loc2_.m_linearVelocity.SetV(_loc23_);
         _loc2_.m_angularVelocity = _loc22_;
      }
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc28_:b2Vec2 = _loc13_.m_sweep.c;
         var _loc30_:Number = _loc13_.m_sweep.a;
         var _loc29_:b2Vec2 = _loc15_.m_sweep.c;
         var _loc31_:Number = _loc15_.m_sweep.a;
         var _loc2_:* = 0.0;
         var _loc26_:* = 0.0;
         var _loc24_:* = false;
         var _loc9_:* = 0.0;
         var _loc14_:b2Mat22 = b2Mat22.FromAngle(_loc30_);
         var _loc16_:b2Mat22 = b2Mat22.FromAngle(_loc31_);
         _loc37_ = _loc14_;
         var _loc34_:Number = m_localAnchor1.x - m_localCenterA.x;
         var _loc39_:Number = m_localAnchor1.y - m_localCenterA.y;
         _loc17_ = _loc37_.col1.x * _loc34_ + _loc37_.col2.x * _loc39_;
         _loc39_ = _loc37_.col1.y * _loc34_ + _loc37_.col2.y * _loc39_;
         _loc34_ = _loc17_;
         _loc37_ = _loc16_;
         var _loc12_:Number = m_localAnchor2.x - m_localCenterB.x;
         var _loc11_:Number = m_localAnchor2.y - m_localCenterB.y;
         _loc17_ = _loc37_.col1.x * _loc12_ + _loc37_.col2.x * _loc11_;
         _loc11_ = _loc37_.col1.y * _loc12_ + _loc37_.col2.y * _loc11_;
         _loc12_ = _loc17_;
         var _loc32_:Number = _loc29_.x + _loc12_ - _loc28_.x - _loc34_;
         var _loc33_:Number = _loc29_.y + _loc11_ - _loc28_.y - _loc39_;
         if(m_enableLimit)
         {
            m_axis = b2Math.MulMV(_loc14_,m_localXAxis1);
            m_a1 = (_loc32_ + _loc34_) * m_axis.y - (_loc33_ + _loc39_) * m_axis.x;
            m_a2 = _loc12_ * m_axis.y - _loc11_ * m_axis.x;
            _loc35_ = m_axis.x * _loc32_ + m_axis.y * _loc33_;
            if(b2Math.Abs(m_upperTranslation - m_lowerTranslation) < 2 * 0.005)
            {
               _loc9_ = b2Math.Clamp(_loc35_,-0.2,0.2);
               _loc2_ = b2Math.Abs(_loc35_);
               _loc24_ = true;
            }
            else if(_loc35_ <= m_lowerTranslation)
            {
               _loc9_ = b2Math.Clamp(_loc35_ - m_lowerTranslation + 0.005,-0.2,0);
               _loc2_ = m_lowerTranslation - _loc35_;
               _loc24_ = true;
            }
            else if(_loc35_ >= m_upperTranslation)
            {
               _loc9_ = b2Math.Clamp(_loc35_ - m_upperTranslation + 0.005,0,0.2);
               _loc2_ = _loc35_ - m_upperTranslation;
               _loc24_ = true;
            }
         }
         m_perp = b2Math.MulMV(_loc14_,m_localYAxis1);
         m_s1 = (_loc32_ + _loc34_) * m_perp.y - (_loc33_ + _loc39_) * m_perp.x;
         m_s2 = _loc12_ * m_perp.y - _loc11_ * m_perp.x;
         var _loc38_:b2Vec3 = new b2Vec3();
         var _loc7_:Number = m_perp.x * _loc32_ + m_perp.y * _loc33_;
         var _loc5_:Number = _loc31_ - _loc30_ - m_refAngle;
         _loc2_ = b2Math.Max(_loc2_,b2Math.Abs(_loc7_));
         _loc26_ = b2Math.Abs(_loc5_);
         if(_loc24_)
         {
            _loc18_ = m_invMassA;
            _loc19_ = m_invMassB;
            _loc22_ = m_invIA;
            _loc23_ = m_invIB;
            m_K.col1.x = _loc18_ + _loc19_ + _loc22_ * m_s1 * m_s1 + _loc23_ * m_s2 * m_s2;
            m_K.col1.y = _loc22_ * m_s1 + _loc23_ * m_s2;
            m_K.col1.z = _loc22_ * m_s1 * m_a1 + _loc23_ * m_s2 * m_a2;
            m_K.col2.x = m_K.col1.y;
            m_K.col2.y = _loc22_ + _loc23_;
            m_K.col2.z = _loc22_ * m_a1 + _loc23_ * m_a2;
            m_K.col3.x = m_K.col1.z;
            m_K.col3.y = m_K.col2.z;
            m_K.col3.z = _loc18_ + _loc19_ + _loc22_ * m_a1 * m_a1 + _loc23_ * m_a2 * m_a2;
            m_K.Solve33(_loc38_,-_loc7_,-_loc5_,-_loc9_);
         }
         else
         {
            _loc18_ = m_invMassA;
            ...
            _loc22_ = m_invIA;
            _loc23_ = m_invIB;
            _loc6_ = _loc18_ + _loc19_ + _loc22_ * m_s1 * m_s1 + _loc23_ * m_s2 * m_s2;
            _loc8_ = _loc22_ * m_s1 + _loc23_ * m_s2;
            _loc25_ = _loc22_ + _loc23_;
            m_K.col1.Set(_loc6_,_loc8_,0);
            m_K.col2.Set(_loc8_,_loc25_,0);
            _loc36_ = m_K.Solve22(new b2Vec2(),-_loc7_,-_loc5_);
            _loc38_.x = _loc36_.x;
            _loc38_.y = _loc36_.y;
            _loc38_.z = 0;
         }
         var _loc3_:Number = _loc38_.x * m_perp.x + _loc38_.z * m_axis.x;
         var _loc4_:Number = _loc38_.x * m_perp.y + _loc38_.z * m_axis.y;
         var _loc20_:Number = _loc38_.x * m_s1 + _loc38_.y + _loc38_.z * m_a1;
         var _loc21_:Number = _loc38_.x * m_s2 + _loc38_.y + _loc38_.z * m_a2;
         _loc28_.x = _loc28_.x - m_invMassA * _loc3_;
         _loc28_.y = _loc28_.y - m_invMassA * _loc4_;
         _loc30_ = _loc30_ - m_invIA * _loc20_;
         _loc29_.x = _loc29_.x + m_invMassB * _loc3_;
         _loc29_.y = _loc29_.y + m_invMassB * _loc4_;
         _loc31_ = _loc31_ + m_invIB * _loc21_;
         _loc13_.m_sweep.a = _loc30_;
         _loc15_.m_sweep.a = _loc31_;
         _loc13_.SynchronizeTransform();
         _loc15_.SynchronizeTransform();
         return _loc2_ <= 0.005 && _loc26_ <= 0.03490658503988659;
      }
   }
}
